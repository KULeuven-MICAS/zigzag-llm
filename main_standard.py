...
CONTEXT_LEN = 256
DECODE_LEN = 256
OUT_PREFIX = f"outputs/df_balanced_2_quant/standard/context_{CONTEXT_LEN}_decode_{DECODE_LEN}/"


def run_experiment():
    # Run prefill
    standard_prefill_config = get_standard_decoding_config_prefill(
    ...
    # Run decode
    standard_decode_config = get_standard_decoding_config_decode(
